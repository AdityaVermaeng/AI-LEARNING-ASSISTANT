...
/**
 * Splite text into chunks for better AI processing
...
//Clena text while preserving paragraph structure
...
// IT adding this paragraph exceeds chunk size, save current chunk
...
//Fallback: if no chanks created, split by words
...
const uniqueWordsFound = queryWords.filter(word => content.includes(word)
).length;
